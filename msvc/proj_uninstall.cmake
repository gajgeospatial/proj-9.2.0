...
if (NOT EXISTS "N:/Development/Dev_Base/proj-9.2.0/msvc/install_manifest.txt")
    message(FATAL_ERROR "Cannot find install manifest: \"N:/Development/Dev_Base/proj-9.2.0/msvc/install_manifest.txt\"")
endif()

set(uninstall_file_list "N:/Development/Dev_Base/proj-9.2.0/msvc/install_manifest.txt")
if(EXISTS "N:/Development/Dev_Base/proj-9.2.0/msvc/install_manifest_extra.txt")
   list(APPEND uninstall_file_list "N:/Development/Dev_Base/proj-9.2.0/msvc/install_manifest_extra.txt")
endif()
